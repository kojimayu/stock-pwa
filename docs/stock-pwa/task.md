...
- [ ] **機能追加: 管理画面のAzure AD認証** <!-- id: 128 -->
    - [x] NextAuth.jsの導入とEntra ID(Azure AD)連携の構成検討 <!-- id: 129 -->
    - [x] 認証関連ファイルの実装 (lib/auth.ts, api/route.ts, middleware.ts) <!-- id: 133 -->
    - [ ] ログイン画面とログアウト機能の実装 <!-- id: 134 -->
...
- [ ] **機能追加: 入荷訂正・取消機能** <!-- id: 100 -->
    ...
    - [x] 発注詳細画面への「取消」ボタン追加 <!-- id: 102 -->
    - [ ] 在庫の自動減算（元に戻す）処理の検証 <!-- id: 103 -->
>>>>>>> a273a47... Update docs after conflict resolution
